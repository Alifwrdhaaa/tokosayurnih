...
<?php if (!empty($_GET['id'])) { ?>
	<?php
	extract($_GET);
	$k = mysqli_query($conn, "SELECT * FROM produk where id='$id'");
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-12 content-menu" style="margin-top:-20px;">
					<?php $kat = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM kategori_produk where id='$data[kategori_produk_id]'"));  ?>
					...
					<p style="font-size:18px">Stok :<?php echo $data['stok'] ?></p>
					<p>
...
<?php } elseif (!empty($_GET['kategori'])) { ?>
	...
	<?php
	extract($_GET);
	$kat = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM kategori_produk where id='$kategori'"));
	?>
	<div class="col-md-9">
		<div class="row">
			<div class="col-md-12">
				...
				<?php
				$k = mysqli_query($conn, "SELECT * FROM produk where kategori_produk_id='$kategori'");
	...
	<div class="col-md-9">
		<div class="row">
			<div class="col-md-12">
				...
				<?php
				$k = mysqli_query($conn, "SELECT * FROM produk");
				while ($data = mysqli_fetch_array($k)) {
				?>
					<div class="col-md-4 content-menu">
						<a href="<?php echo $url; ?>menu.php?id=<?php echo $data['id'] ?>">
