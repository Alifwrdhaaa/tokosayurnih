...
<html lang="en">
  ...
  $qpesanan = mysqli_query($conn,"select * from pesanan where `read`='0'") or die (mysqli_error());
  $totalUnRead = mysqli_num_rows($qpesanan);
  // TOTAL PEMBAYARAN YANG BELUM DI VERIFIKASI
  $qPembayaran = mysqli_query($conn,"select * from pembayaran where `status`='pending'") or die (mysqli_error());
    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Toko Sayurnih Administrator</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse"> 
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo $url ?>admin/index.php">Beranda</a></li>  
			<li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="kota.php">Daftar Ongkir</a></li> 
              </ul>
            </li>
            <li>
            ...
            <li><a href="pengiriman.php">Pengiriman
              <?php if ($totalPending > 0) { ?> <span class="badge"><?php echo $totalPending; ?></span> <?php } ?>
            </a></li> 
            <li><a href="kontak.php">Kontak</a></li> 
            <li><a href="<?php echo $url ?>admin/logout.php">Keluar</a></li> 
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>